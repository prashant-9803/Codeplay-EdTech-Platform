...
const CourseDetails = () => {
  ...
  useEffect(() => {
    //calling fetchCourseDetails to get course details
    (async () => {
      try {
  ...
  //if it is loading or no reponse show loader
  if (loading || !response) {
    return (
  ...
  //if error occurs at fetching course details
  if(!response.success)
  {
    return <Error/>
  }
