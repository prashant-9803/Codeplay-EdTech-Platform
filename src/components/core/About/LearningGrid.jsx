...
const LearningGrid = () => {
  return (
    <div className='grid mx-auto w-[350px] xl:w-[1200px] grid-cols-1 lg:grid-cols-4 mb-12 mt-20'>
    {
        LearningGridArray.map((card, index) => {
            return(
                <div 
                key={index}
                className={`${index === 0 && "xl:col-span-2 xl:h-[294px] bg-richblack-900"} 
                ${
                ...
                }>
                {
                    card.order < 0 
                    ? (
                        <div className='xl:w-[90%] flex flex-col gap-3 pb-10 xl:pb-0  text-richblack-5'>
